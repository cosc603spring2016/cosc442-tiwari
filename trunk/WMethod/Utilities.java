...
public class Utilities{
  ...
  public static void printAllTestCases(Vector<String> testCases, PrintWriter out){
	out.println("\nNumber of Test Cases :"+ testCases.size());
    System.out.println("\nNumber of Test Cases :"+ testCases.size());
    Collections.sort(testCases);
    out.println("Test cases: " + testCases);
  ...
  public static String runFSM(State [] FSM, int stateID, String input, String separator, PrintWriter out) throws IOException {
    ...
    if(FSM[stateID]==null){
    	out.println("\nException occured. \nClass: wAlgorithm \nMethod: runFSM \n Invalid start state. Execution aborted.");
    	out.close();
    ...
    while(inputTokens.hasMoreTokens()){
      ...
      try{
        ...
        out.println(" Input: "+token+" Next state: "+nextState+" Output: "+outputGenerated);
    ...
    Utilities.debugFSMExecution("\nFSM execution completed. Final state: "+currentState);
    out.println("Output pattern:"+outputPattern);
