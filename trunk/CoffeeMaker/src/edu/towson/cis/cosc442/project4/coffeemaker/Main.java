...
public class Main {
    ...
    public static void mainMenu() {
        ...
        System.out.println("0. Exit" + lineSeparator);
	...
	public static void addRecipe() {
	    //Read in recipe name
	    final String name = inputOutput(lineSeparator + "Please enter the recipe name: ");
	    
	    //Read in recipe price
	    final String priceString = inputOutput(lineSeparator + "Please enter the recipe price: $");
	    ...
	    //Read in amt coffee
	    final String coffeeString = inputOutput(lineSeparator + "Please enter the units of coffee in the recipe: ");
	    ...
	    //Read in amt milk
	    final String milkString = inputOutput(lineSeparator + "Please enter the units of milk in the recipe: ");
	    ...
	    //Read in amt sugar
	    final String sugarString = inputOutput(lineSeparator + "Please enter the units of sugar in the recipe: ");
	    ...
	    final String chocolateString = inputOutput(lineSeparator + "Please enter the units of chocolate in the recipe: ");
    ...
    public static void addInventory() {
	    //Read in amt coffee
    	final String coffeeString = inputOutput(lineSeparator + "Please enter the units of coffee to add: ");
    	final int amtCoffee = stringToInt(coffeeString);
	    if(amtCoffee < 0) {
	    	mainMenu();
	    }
	    ...
	    //Read in amt milk
	    final String milkString = inputOutput(lineSeparator + "Please enter the units of milk to add: ");
	    final int amtMilk = stringToInt(milkString);
	    if(amtMilk < 0) {
	    	mainMenu();
	    }
	    ...
	    //Read in amt sugar
	    final String sugarString = inputOutput(lineSeparator + "Please enter the units of sugar to add: ");
	    final int amtSugar = stringToInt(sugarString);
	    if(amtSugar < 0) {
	    	mainMenu();
	    }
	    ...
	    //Read in amt chocolate
	    final String chocolateString = inputOutput(lineSeparator + "Please enter the units of chocolate to add: ");
	    final int amtChocolate = stringToInt(chocolateString);
	    if(amtChocolate < 0) {
	    	mainMenu();
	    }
    ...
    public static void makeCoffee() {
        ...
        System.out.println("Your change is: " + change + lineSeparator);
        mainMenu();
    }
    ...
    private static int stringToInt(String value) {
        ...
        try {
            ...
            System.out.println("Please input an integer" + lineSeparator);
        }
        return returnInt;
    }
    ...
    public static void main(String[] args) {
	    ...
	    System.out.println("Welcome to the CoffeeMaker!" + lineSeparator);
	    mainMenu();
	}
}
