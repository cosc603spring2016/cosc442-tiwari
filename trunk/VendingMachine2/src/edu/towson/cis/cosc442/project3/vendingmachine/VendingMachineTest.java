 ...
 *
 * @generatedBy CodePro at 3/1/15 3:17 PM
 * @author Sabin
...
public class VendingMachineTest {
	...
	/**
	 * Test addItem method of VendingMachine.java to invoke the exception throw.
	 * 
	...
	public void testAddItem_4() {
		...
		//try to add the item again in the same slot
		machine.addItem(item, code);
	}
	...
	public void testMakePurchase_4()
		...
		String code = "C";
		VendingMachine fixture = new VendingMachine();
		fixture.addItem(new VendingMachineItem("Soda", 1.0), code);
		fixture.insertMoney(2.0);
		boolean result = fixture.makePurchase(code);
	...
	public void testMakePurchase_5()
		...
		String code = "B";
		VendingMachine fixture = new VendingMachine();
		fixture.addItem(new VendingMachineItem("Soda", 2.0), code);
		fixture.insertMoney(1.0);
		boolean result = fixture.makePurchase(code);
